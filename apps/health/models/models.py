...
class HealthRecord(models.Model):
    ...
    veterinarian = models.ForeignKey(User, on_delete=models.CASCADE, related_name='health_records', null=True, blank=True)
...
class Vaccination(models.Model):
    ...
    """
    health_record = models.OneToOneField(HealthRecord, on_delete=models.CASCADE, related_name='vaccination_details')
...
class Medication(models.Model):
    ...
    """
    health_record = models.OneToOneField(HealthRecord, on_delete=models.CASCADE, related_name='medication_details')
