...
class FeedRecordAdmin(admin.ModelAdmin):
    list_display = ('flock', 'date', 'feed_type', 'quantity_kg', 'cost_per_kg', 'total_cost', 'recorded_by')
    list_filter = ('feed_type', 'date', 'brand')
    search_fields = ('flock__flock_id', 'brand', 'supplier')
...
class WeightRecordAdmin(admin.ModelAdmin):
    list_display = ('flock', 'date', 'sample_size', 'average_weight', 'age_in_days', 'recorded_by')
    list_filter = ('date',)
    search_fields = ('flock__flock_id',)
...
class EnvironmentalRecordAdmin(admin.ModelAdmin):
    list_display = ('flock', 'date', 'temperature', 'humidity', 'ammonia_level', 'recorded_by')
    list_filter = ('date',)
    search_fields = ('flock__flock_id',)
    readonly_fields = ('created_at',)
